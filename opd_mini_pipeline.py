...
p["ASTROM_REF_IMG"] = "{}/calibdb/20221104_s4c1_CR7_stack.fits".format(sparc4_pipeline_dir)
...
#if options.plot :
# plot light curve
s4plt.plot_light_curve(phot_ts_product, target=target, comps=comps, nsig=100, plot_coords=True, plot_rawmags=True, plot_sum=True, plot_comps=True, catalog_name=p['PHOT_REF_CATALOG_NAME'])
